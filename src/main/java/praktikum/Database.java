...
public class Database {
    ...
    public Database() {
        ...
        buns.add(new Bun("gluten free bun", 150));
        ...
        ingredients.add(new Ingredient(IngredientType.SAUCE, "garlic sauce", 150));
        ...
        ingredients.add(new Ingredient(IngredientType.FILLING, "cheese", 250));
        ingredients.add(new Ingredient(IngredientType.FILLING, "salad", 50));
    }
